...
class BackendSettingTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('psx_backend_settings')->insert([
            'sender_name' => 'SmartTeam',
            'sender_email' => 'info@smart.sd',
            'receive_email' => 'info@smart.sd',
            ...
            'dyn_link_package_name' => 'sd.smart.sooq',
            'dyn_link_domain' => 'sooq.page.link',
            'dyn_link_deep_url' => 'https://smart.sd/buysell-fe-dev/item/',
            'ios_boundle_id' => 'sd.smart.sooq',
